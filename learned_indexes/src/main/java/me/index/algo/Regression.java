...
public class Regression implements Splittable {
    ...
    //Разбивает отсортированный массив keys на непересекающиеся сегменты,
    // так что каждый сегмент аппроксимируется одной линейной моделью с ошибкой не более maxErr.
    @Override
